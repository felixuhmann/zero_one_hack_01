 ...
 * default `http://127.0.0.1:8000`). The backend is implemented in a later
 * step; the exact wire contract this client expects is documented in
 * `docs/chat-api.md` at the repo root.
 */
